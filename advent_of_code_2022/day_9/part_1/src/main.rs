...
impl XYPos {
    ...
    pub fn move_tail(&mut self, head_pos: &XYPos) {
...
fn main() {
    ...
    let mut head_pos = XYPos::new(0, 0);
    let mut tail_pos = XYPos::new(0,0);

    tail_visited.insert(tail_pos.clone());
